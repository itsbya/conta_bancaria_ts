...
function deletarContaPorNumero(): void{
    ...
    console.log('Deseja realmente excluir a conta ?');
    let validacao: number = Input.keyInSelect( ['sim', 'não'], '');
...
function sobre(): void {
    ...
    console.log("Ana Beatriz Carvalho - anabeatrizcarvalhoesmaile@gmail.com");
